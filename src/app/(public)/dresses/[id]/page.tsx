...
import { ArrowLeft, Calendar, Star, Heart, Share2, ShoppingBag } from "lucide-react";
    ...
    <div className="pt-20 pb-16 min-h-screen bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          {/* Details */}
          <div>
            <Badge className="mb-3 bg-brand-50 text-brand-600 border-brand-200 hover:bg-brand-50 capitalize">
              {dress.category}
            </Badge>
            ...
            <div className="bg-brand-50 rounded-2xl p-5 mb-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="font-display text-2xl font-bold text-brand-600">
                  {formatCurrency(dress.rental_price ?? 0)}
            ...
            <div className="space-y-3">
              <Link href="/register" className="block">
                <Button size="lg" className="w-full gap-2" disabled={!dress.available}>
                  <Calendar className="w-5 h-5" />
                  {dress.available ? "Book for Rental" : "Currently Unavailable"}
                </Button>
              </Link>
